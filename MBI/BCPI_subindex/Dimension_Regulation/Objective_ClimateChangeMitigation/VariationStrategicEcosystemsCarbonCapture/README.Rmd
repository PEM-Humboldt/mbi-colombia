...
output<- "C:/Repositories/MBI_Colombia/MBI/BCPI_subindex/Dimension_Regulation/Objective_ClimateChangeMitigation/VariationStrategicEcosystemsCarbonCapture/script/output_Colombia"
area_cobsNat_ecosystem<- openxlsx::read.xlsx( file.path(output, paste0("area_cobsNat_ecosystem", ".xlsx"))) 
knitr::kable(area_cobsNat_ecosystem)
```
