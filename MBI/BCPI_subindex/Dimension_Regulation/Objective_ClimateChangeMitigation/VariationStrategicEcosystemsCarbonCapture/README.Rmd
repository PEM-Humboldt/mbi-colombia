...
Las entradas de ejemplo de este ejercicio están almacenadas en [IAvH/Unidades compartidas/MBI/VariationStrategicEcosystemsCarbonCapture](https://drive.google.com/open?id=14fv_-wjqdcWIaQMBiGeY2zScZiwXgRWm&usp=drive_fs). Están organizadas de esta manera que facilita la ejecución del código:
